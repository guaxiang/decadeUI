	...
	const plugin = {
		...
		create: {
			...
			handcardNumber() {
				...
				if (isTouch) {
					if (lib.config["extension_十周年UI_rightLayout"] === "on") {
						const node6 = ui.create.div(".huanfuButton_new", ui.arena, ui.click.pause);
						const node7 = ui.create.div(".jiluButton_new", ui.arena, plugin.click.talk);
						const node8 = ui.create.div(".meiguiButton_new", ui.arena);
						const node9 = ui.create.div(".xiaolianButton_new", ui.arena, plugin.click.xiaolian);
					}
				}
